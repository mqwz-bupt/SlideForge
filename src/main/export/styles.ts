...
`
  ...
  'cinematic': {
    ...
    titleSubtitleColor: 'rgba(245,240,232,0.6)',
    contentBg: '#0a0a0a',
...
`
  ...
  'neo-brutalist': {
    ...
    contentHeaderBorder: '#1a1a1a',
    contentTitleColor: '#1a1a1a',
    contentBulletColor: 'rgba(26,26,26,0.65)',
